...
We evaluated the baseline PRS logistic model and three machine learning models using effect allele counts. Because the dataset is imbalanced (CRC cases vs controls), model performance was assessed using precision–recall AUC (PR_AUC), F1-score, ROC-AUC, and balanced accuracy.
